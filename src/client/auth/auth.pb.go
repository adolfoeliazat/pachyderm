...
type AuthConfiguration struct {
	IDProvider    []*AuthConfiguration_IDProvider  `protobuf:"bytes,1,rep,name=id_provider,json=idProvider" json:"id_provider,omitempty"`
	SAMLSPOptions *AuthConfiguration_SAMLSPOptions `protobuf:"bytes,2,opt,name=saml_sp_options,json=samlSpOptions" json:"saml_sp_options,omitempty"`
}
...
type AuthConfiguration_IDProvider struct {
	...
	Saml        *AuthConfiguration_IDProvider_SAMLOptions `protobuf:"bytes,3,opt,name=saml" json:"saml,omitempty"`
}
...
func (m *AuthConfiguration_IDProvider) GetSaml() *AuthConfiguration_IDProvider_SAMLOptions {
	if m != nil {
		return m.Saml
	}
	return nil
...
type SetConfigurationRequest struct {
	// If set, Pachyderm will write 'configuration' to its storage system inside
	// a transaction that confirms the current configuration has the checksum
	// 'initial_config_checksum'. This allows reading, modifying, and writing the
	// Pachyderm auth config without the risk of conflicting writes from other
	// users
	InitialConfigChecksum string             `protobuf:"bytes,1,opt,name=initial_config_checksum,json=initialConfigChecksum,proto3" json:"initial_config_checksum,omitempty"`
	Configuration         *AuthConfiguration `protobuf:"bytes,2,opt,name=configuration" json:"configuration,omitempty"`
}
...
func (m *SetConfigurationRequest) GetInitialConfigChecksum() string {
	if m != nil {
		return m.InitialConfigChecksum
	}
	return ""
}
...
func (m *AuthConfiguration_IDProvider) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Saml != nil {
		...
		n2, err := m.Saml.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n2
...
func (m *SetConfigurationRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.InitialConfigChecksum) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintAuth(dAtA, i, uint64(len(m.InitialConfigChecksum)))
		i += copy(dAtA[i:], m.InitialConfigChecksum)
	}
	if m.Configuration != nil {
		dAtA[i] = 0x12
		i++
...
func (m *AuthConfiguration_IDProvider) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.Saml == nil {
				m.Saml = &AuthConfiguration_IDProvider_SAMLOptions{}
			}
...
func (m *SetConfigurationRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InitialConfigChecksum", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.InitialConfigChecksum = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Configuration", wireType)
...
var fileDescriptorAuth = []byte{
	...
	,
}
